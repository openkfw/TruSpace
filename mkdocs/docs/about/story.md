---
title: "Your Place or My Place?"
description: A tale of decentralization and sovereignty — the story behind TruSpace
...
And boy, did her institution *love* documents.
...
That sounded like volunteering to host a family reunion… for *someone else's* family.

---

## Scene 3: Meanwhile, at the Client's Office…

Over in another IT department, **Greg** — the client's IT admin — was having the *exact same conversation*.

> **Greg:** "Wait, you want us to use *our* platform? What if they mess up? Or if their cat walks across the keyboard and deletes everything? No way. Let's use *their* system instead."
...
> **Alex:** "Why don't you just use a *decentralized* solution?"
...
> "Instead of uploading your documents to *my* server or *your* server, we upload them to a **peer-to-peer network**.
...
- Without it, other nodes don't even *know* you exist.
...
**Interested in how this works in real life?** That's exactly what TruSpace is — an open source, AI-infused, decentralized document management system. See the [Architecture Overview](../architecture/overview.md) or jump straight into the [Quick Start](../getting-started/quickstart.md).
