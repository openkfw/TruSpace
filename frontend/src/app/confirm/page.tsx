    ...
    <div className="flex min-h-svh w-full items-center justify-center p-4 md:p-10">
      <div className="w-full max-w-sm">
        <div className="flex flex-col gap-6">
          <Image src="/images/TruSpaceLogo.svg" alt="TruSpace Logo" width={500} height={400} priority />
          <Card>
            <CardHeader>
            ...
            <CardContent>
              <div className="flex flex-col gap-6">
                <Button type="submit" className="w-full" data-test-id="confirm-registration" onClick={onConfirmClick}>
